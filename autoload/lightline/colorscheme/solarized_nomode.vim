" =============================================================================
" Filename: autoload/lightline/colorscheme/solarized_nomode.vim
" Author: BertrandSim
" License: MIT License
" Last Change: 2020-03-30
" Based on solarized colorscheme for itchyny/lightline.vim, 
" but without color differentiation across non-insert modes 
" on left side of statusline
" =============================================================================
...
let s:p.inactive.left =  [ [ s:base03, s:base00 ], [ s:base0, s:base02 ] ]

let s:p.insert.left = [ [ s:base03, s:green ], [ s:base03, s:base00 ] ]
" let s:p.replace.left = [ [ s:base03, s:red ], [ s:base03, s:base00 ] ]
" let s:p.visual.left = [ [ s:base03, s:magenta ], [ s:base03, s:base00 ] ]
let s:p.replace.left = [ [ s:base03, s:blue ], [ s:base03, s:base00 ] ]
let s:p.visual.left = [ [ s:base03, s:blue ], [ s:base03, s:base00 ] ]
...
let g:lightline#colorscheme#solarized_nomode#palette = lightline#colorscheme#flatten(s:p)
