" Vim syntax file for R code
" Modified from vim's syntax 
" Note: remove debugging stuff when done
...
"clear previous syntax file. for debugging
if exists("b:current_syntax")
  syntax clear    
endif
